...
class EventHandler:
    ...
    def place_block(self, pos):
        ...
        level.tableau_image[pos_x_grille, pos_y_grille] = level.selected_block
...
class Level:
    def __init__(self):
        ...
        self.tableau_image = np.load("level_image_data.npy")
    ...
    def get_subsurface(self, block_id):
        if block_id == 0:
            ...
            img.fill((50, 200, 200, 255))
            return img
        else:
            block_id -= 1
            
        rect = Rect((block_id % 5) * TAILLE_BLOC, (block_id // 5) * TAILLE_BLOC, TAILLE_BLOC, TAILLE_BLOC)
